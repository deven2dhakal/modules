if Facter.value(:kernel) == "Linux"
  ...
  if not lspci.nil?
    ...
    dev_classes.each do |dev_class|
        ...
        when dev_class
          ["Vendor","Device","Driver"].each do |a|
            if devices[devidentifier].has_key?(a)
              ...
              #The print statement below Lists all named devices
              #puts "#{dev_name}_#{a.downcase}"
      ...
      #The print statement Lists all the PCI Classes
      #puts "#{dev_class.downcase.gsub(' ','_')}s"
